...
public class StartWindow {
	...
	ActionListener actionListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == btnScores) {
				...
				JOptionPane.showMessageDialog(null, saveAndLoad.getResults());
	...
	private void initialize() {
		...
		lblPhoto = new JLabel("");
		img = new ImageIcon("C://Users//HP//workspace//game maze SaveAndLoad//src//Gui//index.png");
		lblPhoto.setIcon(img);
		lblPhoto.setBounds(532, 200, 224, 227);
		panel_main.add(lblPhoto);

		lblLogo = new JLabel("");
		img = new ImageIcon("C://Users//HP//workspace//game maze SaveAndLoad//src//Gui//logo.png");
		lblLogo.setIcon(img);
		...
		btnScores.setFont(new Font("Verdana", Font.BOLD, 23));
		btnScores.setBounds(600, 559, 142, 41);
		btnScores.setContentAreaFilled(false);
		btnScores.setFocusPainted(false);
		btnScores.setBorderPainted(false);
		btnScores.addActionListener(actionListener);
